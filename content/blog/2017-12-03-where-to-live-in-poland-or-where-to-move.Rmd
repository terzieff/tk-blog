...
The biggest downside of the free plan of their API is that it lets you make max. 10 calls per minute, so I had to put some "sleep time" into my functions and wait around 20 minutes to get all the data I needed.

Finally, however, I could plot my final output, and now we can all choose some warm (or cold, if you prefer), big city located in one of the least authoritative countries in the world. Enjoy.
